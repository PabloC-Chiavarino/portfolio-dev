            ...
            <ScrollSpy>
                ...
                <div className='profile-item' id='proyects'>
                    ...
                    <div className='proyects-container'>
                        ...
                        <p>Proyecto "old school code" sobre venta de artículos tecnológicos (e-commerce). Construído en Vanilla JavaScript y mockAPI, actualmente en proceso de versión 1.5</p>
                        ...
                        <p>Proyecto con estándares actuales. E-commerce sobre venta de notebooks para distintos perfiles de usuario. Construído en React Js con base de datos en Google Firestore. Actualmente terminando su version 2.0 (desarrollo de sistema de usuarios con whislist)</p>
